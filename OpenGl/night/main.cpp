...
void border();
void tree1();//border tree
void color();//day color
void tree2();//day tree
void circle1(GLfloat x,GLfloat y,GLfloat radius);
void moon1();//night moon
void sun1();//day sun
void modifynight();//changing the shape of moon
void movesun();//change position of sun
